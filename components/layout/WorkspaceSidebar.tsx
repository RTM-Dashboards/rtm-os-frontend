...
const WORKSPACE_NAV_OVERRIDES: Record<string, WorkspaceNavItem[]> = {
  ...
  billing: [
    ...
    { label: "Activation Queue",  href: "/billing/activation-queue",  group: "ACTIVATION" },
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="px-4 py-3 flex-shrink-0"style={{ borderBottom: "1px solid var(--rtm-sidebar-border)"}}
        >
          <div
            className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg"style={{ background: "rgba(255,255,255,0.07)"}}
          >
            <div
              className="w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0"style={{ background: workspace.accentColor, color: "#fff"}}
            >
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4">
          ...
          <Link
            href="/admin"onClick={onClose}
            className="flex items-center gap-2 px-3 py-2 mb-3 rounded-lg text-xs font-semibold transition-all"style={{ color: "rgba(200,213,238,0.6)"}}
            onMouseEnter={(e) => {
          ...
          <p
            className="px-3 mb-2 text-[10px] font-bold uppercase tracking-widest"style={{ color: "rgba(200,213,238,0.35)"}}
          >
            {workspace.name}
          </p>
                  ...
                  {hasChildren ? (
                    <div>
                      <button
                        ...
                        className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150"style={linkStyle(active)}
                        onMouseEnter={(e) => {
                          if (!active) {
                            e.currentTarget.style.background = "rgba(255,255,255,0.07)";
                            e.currentTarget.style.color = "#ffffff";
                    ...
                    <Link
                      href={item.href}
                      onClick={onClose}
                      className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150"style={linkStyle(active)}
                      onMouseEnter={(e) => {
                        if (!active) {
                          e.currentTarget.style.background = "rgba(255,255,255,0.07)";
                          e.currentTarget.style.color = "#ffffff";
