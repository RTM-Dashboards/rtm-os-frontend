  ...
  return (
    ...
    >
      ...
      <InfoRow
        ...
        value={<InlineTag label={b.contractStatus} style={CONTRACT_STYLES[b.contractStatus]} />}
      />
      <InfoRow
        label="Invoice Status"
        value={<InlineTag label={b.invoiceStatus} style={INVOICE_STYLES[b.invoiceStatus]} />}
      />
      <InfoRow
        label="Payment Status"
        value={<InlineTag label={b.paymentStatus} style={PAYMENT_STYLES[b.paymentStatus]} />}
      />
