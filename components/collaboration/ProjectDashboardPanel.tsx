      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-3">
        {[
          ...
          <div
            ...
            style={{ background: kpi.bg, border: `1px solid ${kpi.bg === "#FEF2F2" ? "#FECACA" : "var(--rtm-border)"}` }}
          >
          ...
          <div className="space-y-0">
            {allActivity.map((ev, idx) => (
              <div
                ...
                style={{ borderBottom: idx < allActivity.length - 1 ? "1px solid var(--rtm-border-light)" : "none" }}
              >
                ...
                >
                  <div className="flex items-center justify-between gap-2 mb-1">
                    ...
                    <span
                      ...
                      style={{ background: e.status === "Open" ? "#FEE2E2" : "#DBEAFE", color: e.status === "Open" ? "#991B1B" : "#1E40AF" }}
                    >
                      {e.status}
                    </span>
                  </div>
    ...
    >
      <div className="flex items-center justify-between gap-2 mb-3">
        ...
        {count > 0 && (
          <span
            className="text-[10px] px-2 py-0.5 rounded-full font-bold"
            style={{ background: alertColor ? "#FEE2E2" : "var(--rtm-bg)", color: alertColor ?? "var(--rtm-text-muted)" }}
          >
            {count}
          </span>
        )}
