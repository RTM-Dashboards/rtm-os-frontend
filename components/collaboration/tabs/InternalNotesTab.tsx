...
export default function InternalNotesTab({ notes }: Props) {
  ...
  return (
    <div className="space-y-4">
      {/* Banner */}
      <div
        className="flex items-center gap-2 p-3 rounded-lg text-xs font-medium"style={{ background: "#FEF9C3", border: "1px solid #FDE68A", color: "#92400E"}}
      >
      ...
      >
        ...
        <textarea
          rows={3}
          placeholder="e.g. Waiting for payment. Waiting for client approval. Need manager review."className="w-full resize-none rounded-lg px-3 py-2 text-sm outline-none"style={{
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <button
            className="text-xs px-4 py-1.5 rounded-lg font-semibold text-white"style={{ background: "#92400E"}}
          >
            Add Note
          </button>
        </div>
