...
export default function ClientNotesTab({ notes }: Props) {
  ...
  return (
    <div className="space-y-4">
      {/* Banner */}
      <div
        className="flex items-center gap-2 p-3 rounded-lg text-xs font-medium"style={{ background: "#DBEAFE", border: "1px solid #BFDBFE", color: "#1E40AF"}}
      >
          ...
          >
            ...
            <div className="flex items-start justify-between gap-3 mb-3">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <span
                  className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-semibold"style={{ background: iconStyle.bg, color: iconStyle.color }}
                >
      ...
      >
        ...
        <textarea
          rows={3}
          placeholder="e.g. Client requested launch delay. Client approved strategy. Client requested revisions."className="w-full resize-none rounded-lg px-3 py-2 text-sm outline-none"style={{
        ...
        <div className="flex items-center justify-between mt-2">
          <select
            className="text-xs px-2 py-1 rounded outline-none"style={{ background: "var(--rtm-blue-light)", color: "var(--rtm-blue)", border: "none"}}
          >
          ...
          <button
            className="text-xs px-4 py-1.5 rounded-lg font-semibold text-white"style={{ background: "#1E40AF"}}
          >
            Save Note
          </button>
        </div>
