        ...
        return (
          <div key={event.id} className="flex gap-3">
            ...
            <div className="flex flex-col items-center flex-shrink-0" style={{ width: 32 }}>
              <div
                className="w-7 h-7 rounded-full flex items-center justify-center text-[9px] font-bold text-white z-10"
            ...
            <div className="flex-1 pb-4">
              ...
              {event.notes && (
                <p
                  className="mt-1 ml-8 text-xs leading-relaxed px-2 py-1.5 rounded-lg"
                  style={{ background: "var(--rtm-bg)", color: "var(--rtm-text-secondary)", border: "1px solid var(--rtm-border-light)" }}
                >
                  {event.notes}
                </p>
              )}
