...
import type { DeptLaunchRow, DeptStatus } from "@/lib/am-data";
...
export default function DepartmentLaunchStatus({ rows }: Props) {
  ...
  return (
    <SectionWrapper
      title="Department Launch Assignment Status"
      description="Per-client dept task tracking for all onboarding accounts"
    >
