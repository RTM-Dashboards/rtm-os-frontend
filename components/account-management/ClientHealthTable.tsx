...
export default function ClientHealthTable({ rows }: Props) {
  ...
  return (
    <SectionWrapper
      ...
      description="Full client health overview"
      actions={
    ...
    >
              ...
              >
                ...
                <td className="px-3 py-3 whitespace-nowrap text-center">
                  <span
                    ...
                    style={{ color: row.openDeliverables > 3 ? "#D97706" : "var(--rtm-text-secondary)" }}
                  >
      ...
      <div className="mt-4">
        <Link
          href="/account-management/clients"
          className="rtm-btn-secondary inline-flex items-center gap-1.5 text-xs"
        >
          View All Clients →
        </Link>
      </div>
