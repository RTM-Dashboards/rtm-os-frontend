...
export default function DepartmentTasksPanel({ accentColor, disabled }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Tasks table */}
      <SectionWrapper
        title="Task Queue"description="All assigned tasks"noPadding
        actions={
              ...
              {MOCK_TASKS.map((task) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td
                      className="py-2.5 px-3 whitespace-nowrap font-medium"style={{ color: task.status === "overdue"? "#DC2626": "var(--rtm-text-secondary)"}}
                    >
                      {task.dueDate}
                    </td>
                  </tr>
