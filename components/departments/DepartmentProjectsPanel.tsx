...
export default function DepartmentProjectsPanel({ accentColor, disabled }: Props) {
  ...
  return (
    <SectionWrapper
      title="Assigned Projects"description="Projects assigned to this department — sourced from Operations"actions={
        <a
          href="/operations"className="text-xs font-medium hover:underline"style={{ color: accentColor }}
        >
          View in Operations
        </a>
      }
