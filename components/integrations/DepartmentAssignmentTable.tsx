...
export default function DepartmentAssignmentTable({ assignments, integrations }: Props) {
  return (
    <SectionWrapper
      title="Department Integration Assignment"
      description="Connected integrations per department — configurable without code changes"
      actions={
        <button
        ...
        {assignments.map((dept) => {
          ...
          return (
            <div
              ...
              style={{ background: "var(--rtm-surface-raised, #F8FAFC)", borderColor: "var(--rtm-border)" }}
            >
