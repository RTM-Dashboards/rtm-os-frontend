...
export default function AIRecommendationsPanel({ recommendations, integrations }: Props) {
  ...
  return (
    <SectionWrapper
      title="AI Integration Recommendations"
      description="AI-generated analysis of unused, redundant, and missing connector configurations"
      actions={
        <button
          className="px-3 py-1.5 rounded-lg text-xs font-semibold border transition-colors flex items-center gap-1.5"
          style={{ color: "var(--rtm-blue)", borderColor: "var(--rtm-blue-light)", background: "var(--rtm-blue-xlight)" }}
        >
        ...
        {ordered.map((rec) => {
          ...
          return (
            <div
              ...
              style={{ background: typeConf.bg, borderColor: typeConf.border }}
            >
              <div className="flex items-start gap-3">
                <div
                  className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5"
                  style={{ background: "white", color: typeConf.color, border: `1px solid ${typeConf.border}` }}
                >
                  {typeConf.icon}
                </div>
              ...
              <div className="flex gap-2 mt-3 pl-11">
                ...
                <button
                  className="text-xs font-medium px-2.5 py-1 rounded-lg border transition-colors"
                  style={{ color: "var(--rtm-text-muted)", borderColor: "var(--rtm-border)", background: "white" }}
                >
                  Dismiss
                </button>
              </div>
