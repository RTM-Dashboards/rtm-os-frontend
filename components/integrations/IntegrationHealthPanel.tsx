...
export default function IntegrationHealthPanel({ integrations }: Props) {
  ...
  return (
    <SectionWrapper
      title="Integration Health Monitor"description="Real-time health scores across all configured connectors">
      {/* Issues first */}
      {withIssues.length > 0 && (
        <div className="mb-5">
...
function HealthRow({ integration }: { integration: Integration }) {
  return (
    <div
      className="flex items-center gap-4 p-3 rounded-xl border"style={{
