    ...
    <>
      ...
      {open && (
        <div
          ...
          style={{ background: "rgba(14,32,85,0.45)", backdropFilter: "blur(2px)" }}
          onClick={onClose}
          aria-hidden="true"
        />
      )}
      ...
      >
        ...
        {tabs.length > 1 && (
          <div
            className="flex-shrink-0 flex items-center gap-0.5 px-4 overflow-x-auto"
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className="relative flex items-center gap-1.5 px-3 py-3 text-xs font-semibold whitespace-nowrap transition-colors"
                  style={{
