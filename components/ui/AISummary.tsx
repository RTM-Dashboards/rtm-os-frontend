      ...
      {items.map((item, i) => (
        <li key={i} className="flex items-start gap-2">
          <span
            ...
            style={{ background: urgencyDot[item.urgency ?? "info"] }}
          />
    ...
    >
      ...
      {hc && (
        <div
          ...
          style={{ background: hc.bg, borderBottom: `1px solid ${hc.border}` }}
        >
      ...
      {disclaimer && !loading && (
        <div
          className="px-5 py-2.5 flex items-center justify-end"
