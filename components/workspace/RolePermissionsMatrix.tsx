  ...
  return (
    <div className="space-y-4">
      ...
      <SectionWrapper
        ...
        description={`${permissionAreas.length} permission areas across ${roles.length} roles`}
        noPadding
      >
          ...
          <table className="w-full text-sm">
            <thead>
              <tr style={{ borderBottom: "1px solid var(--rtm-border-light)" }}>
                <th
                  className="px-4 py-3 text-left text-xs font-semibold w-52"
                ...
                {roles.map((r) => (
                  ...
                  >
                    <span
                      className="inline-block px-2 py-0.5 rounded-full border font-bold text-[11px]"
                      style={{
