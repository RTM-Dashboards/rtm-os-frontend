...
export const workspaces: WorkspaceConfig[] = [
  // ─── Account Management ────────────────────────────────────────────────────
  {
    ...
    navItems: [
      ...
      { label: "Client Onboarding",  href: "/account-management/onboarding"},
      ...
      { label: "Performance",      href: "/account-management/performance"},
      { label: "Reports",          href: "/account-management/reports"},
    ],
  },
  ...
  // ─── Sales ────────────────────────────────────────────────────────────────
  {
    ...
    navItems: [
      ...
      { label: "Audits",             href: "/sales/proposals",         icon: "🔎" },
