...
export const workspaces: WorkspaceConfig[] = [
  ...
  // ─── Sales ────────────────────────────────────────────────────────────────
  {
    ...
    navItems: [
      ...
      { label: "Proposal Builder",   href: "/sales/proposals?new=true",      group: "PROPOSALS" },
      { label: "Audits",             href: "/sales/audits",                  group: "PROPOSALS" },
      { label: "Proposals",          href: "/sales/proposals",               group: "PROPOSALS" },
      { label: "Contracts",          href: "/sales/contracts",               group: "PROPOSALS" },
      { label: "Handoffs",           href: "/sales/handoffs",                group: "PROPOSALS" },
