...
export const workspaces: WorkspaceConfig[] = [
  // ─── Account Management ────────────────────────────────────────────────────
  {
    ...
    navItems: [
      ...
      { label: "AM Performance Analytics", href: "/account-management/performance"},
      { label: "Executive Account View",   href: "/account-management/executive"},
  ...
  // ─── Billing ─────────────────────────────────────────────────────────────
  {
    ...
    accentColor: "#D97706",
    role: "Billing Team",
    // amber kept: financial/billing has semantic attention-required meaning
    navItems: [
  ...
  // ─── Web Development & Design ─────────────────────────────────────────────
  {
    ...
    navItems: [
      ...
      { label: "Clients",     href: "/web-development-design/clients"},
  ...
  // ─── Paid Advertising ────────────────────────────────────────────────────
  {
    ...
    navItems: [
      ...
      { label: "Clients",     href: "/paid-advertising/clients"},
  ...
  // ─── IT & Security ──────────────────────────────────────────────────────
  {
    ...
    navItems: [
      ...
      { label: "Clients",      href: "/it-security/clients"},
      { label: "Performance",  href: "/it-security/performance"},
