    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        ...
        <Link
          ...
          className="rtm-btn-secondary text-sm inline-flex items-center gap-1 self-start"
        >
          Settings
        </Link>
      </div>
        ...
        {TYPE_ORDER.map((type) => {
          ...
          return (
            <div
              ...
              style={{ background: cfg.bg, borderColor: "var(--rtm-border-light)" }}
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {depts.map((dept) => (
                <Link
                  key={dept.id}
                  href={dept.baseRoute}
                  className="group block rounded-xl border p-5 transition-all hover:shadow-md hover:opacity-90"
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div
                      ...
                      style={{ background: `${dept.accentColor}18`, color: dept.accentColor }}
                    >
                      {dept.name.charAt(0)}
                    </div>
                    ...
                    {dept.modules
                      ...
                      .map((m) => (
                        <span
                          ...
                          style={{ background: `${dept.accentColor}12`, color: dept.accentColor }}
                        >
                          {m.label}
                        </span>
                      ))}
