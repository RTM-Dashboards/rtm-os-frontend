...
function KpiPill({ label, value, color }: { label: string; value: string | number; color: string }) {
  return (
    <div
      className="flex flex-col gap-1 px-4 py-3 rounded-xl border min-w-[120px]"
...
const navCards = [
  ...
  { title: "Settings",           description: "Billing configuration, payment methods, and preferences.",         href: "/billing/settings",           icon: "⚙️", accent: "#6B7280", bg: "#F9FAFB", border: "#E5E7EB" },
];
  ...
  return (
    <div className="space-y-8">
      ...
      <SectionWrapper
        ...
        description="30 invoices — all types and statuses"
        actions={
      ...
      <SectionWrapper
        title="Collections"
        description="Outstanding overdue accounts requiring follow-up"
        actions={
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {collections.map((c) => (
            <div
              ...
              style={{ background: c.daysOverdue >= 30 ? "#FEF2F2" : "var(--rtm-bg)", borderColor: c.daysOverdue >= 30 ? "#FECACA" : "var(--rtm-border-light)" }}
            >
      ...
      <SectionWrapper
        ...
        description="Billing controls project activation — payment required before activation"
        actions={
      ...
      <SectionWrapper
        ...
        description="MRR, ARR, active contracts, upcoming renewals"
        actions={
