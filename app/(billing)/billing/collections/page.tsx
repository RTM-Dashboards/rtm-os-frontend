...
import { collections, invoices } from "@/lib/billing-mock-data";
import type { CollectionStatus } from "@/lib/billing-mock-data";
  ...
  return (
    <div className="space-y-8">
      ...
      <SectionWrapper
        ...
        description="All overdue and outstanding accounts with collection statuses"
        actions={
            ...
            <tbody>
              {filtered.map((c) => (
                <tr
                  ...
                  style={{ background: c.daysOverdue >= 30 ? "#FFF7F7" : "var(--rtm-bg)" }}
                >
                  ...
                  <Td>
                    <span
                      className="font-bold"
                      style={{ color: c.outstandingAmount >= 2000 ? "#DC2626" : c.outstandingAmount >= 1000 ? "#D97706" : "var(--rtm-text-primary)" }}
                    >
                  ...
                  <Td>
                    <span
                      ...
                      style={{ color: c.daysOverdue >= 30 ? "#DC2626" : c.daysOverdue >= 10 ? "#D97706" : "#059669" }}
                    >
