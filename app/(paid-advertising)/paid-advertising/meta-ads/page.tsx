  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        <KpiCard title="Total Meta Spend" value="$12,400" trend="up" trendValue="+6% MoM"
        ...
        />
        <KpiCard title="Avg. ROAS" value="3.9x" trend="up" trendValue="+0.2x"
        ...
        />
        <KpiCard title="Leads (MTD)" value="308" trend="up" trendValue="+42 vs last"
        ...
        <KpiCard title="Active Campaigns" value="9" trend="up" trendValue="+1"
          ...
          icon={<svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M15 15l-2 5L9 9l11 4-5 2zm0 0l5 5" /></svg>}
        />
      </div>
