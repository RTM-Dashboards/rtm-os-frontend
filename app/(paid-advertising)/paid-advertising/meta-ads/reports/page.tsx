...
export default function MetaAdsReportsPage() {
  return (
    <DeptReportPage
      title="Meta Ads Reports"description="Meta Ads report management — source data for Paid Advertising Reporting Workspace."accent="#1877F2"dept="Meta Ads"reports={metaAdsDeptReports}
      kpis={kpis}
