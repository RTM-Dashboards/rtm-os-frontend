            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-48 px-3 py-2 rounded-lg border text-sm outline-none"
              ...
              {[
                ...
                <div key={s.key} className="flex items-center justify-between p-4 rounded-lg" style={{ background: "var(--rtm-bg)", border: "1px solid var(--rtm-border-light)" }}>
                  ...
                  >
                    <span
                      className="inline-block w-4 h-4 rounded-full bg-white transition-transform shadow"
                      style={{ transform: (systemSettings as Record<string, unknown>)[s.key] ? "translateX(24px)" : "translateX(4px)" }}
                    />
                  </button>
                </div>
              ))}
            ...
            >
              ...
              <div className="flex gap-2 flex-shrink-0">
                ...
                {role.name !== "Super Admin" && (
                  <button
                    className="text-xs px-3 py-1.5 rounded-lg border font-medium"
                    style={{ borderColor: "var(--rtm-border)", color: "#EF4444", background: "var(--rtm-bg)" }}
                  >
                    Remove
                  </button>
                )}
                        ...
                        {allRoles.map((r) => (
                          <td key={r} className="px-3 py-3 text-center">
                            {perm.roles.includes(r) ? (
                              <span
                                className="inline-block w-5 h-5 rounded-full text-white text-xs font-bold leading-5"
                              ...
                              <span
                                ...
                                style={{ background: "var(--rtm-bg)", border: "1px solid var(--rtm-border-light)", color: "var(--rtm-text-muted)" }}
                              >
                                —
                              </span>
                            )}
