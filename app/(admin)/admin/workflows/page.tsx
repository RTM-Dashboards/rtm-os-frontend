  ...
  return (
    <div className="space-y-6">
      ...
      <TaskAccessCard
        ...
        counters={{ open: 27, overdue: 4, dueToday: 9, completed: 41, upcoming: 16 }}
        createLabel="Create Workflow Task"
        examples={["Proposal Approved → Invoice Task", "Invoice Paid → Assign AM", "Renewal Due → Renewal Task", "Cancellation → Offboarding Task"]}
      />
            ...
            >
              ...
              <div className="px-4 py-3 bg-white" style={{ borderTop: `1px solid ${item.border}` }}>
                ...
                <div className="flex gap-2">
                  <Link
                    href="/tasks"
                    className="text-[11px] font-bold px-2.5 py-1 rounded-lg text-white transition-opacity hover:opacity-90"
                    style={{ background: item.color }}
                  >
                    Open Tasks
                  </Link>
            ...
            <tbody>
              {RECENT_WORKFLOW_TASKS.map((task, i) => (
                <tr
                  ...
                  style={{ borderBottom: i < RECENT_WORKFLOW_TASKS.length - 1 ? "1px solid var(--rtm-border-light)" : "none" }}
                >
                  ...
                  <td className="px-4 py-3">
                    <span
                      ...
                      style={{ background: task.statusBg, color: task.statusColor, borderColor: task.statusBg }}
                    >
                      {task.status}
                    </span>
                  </td>
