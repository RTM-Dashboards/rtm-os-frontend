    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          <div
            key={k.label}
            className="rounded-xl border p-4"style={{ background: "var(--rtm-surface)", borderColor: "var(--rtm-border)"}}
          >
      ...
      <div className="flex flex-wrap gap-3">
        <input
          ...
          className="flex-1 min-w-[200px] px-3 py-2 rounded-lg border text-sm outline-none"style={{
        ...
        <select
          ...
          className="px-3 py-2 rounded-lg border text-sm outline-none"style={{
            background: "var(--rtm-surface)",
            borderColor: "var(--rtm-border)",
            color: "var(--rtm-text-primary)",
          }}
      ...
      >
            ...
            <thead>
              <tr style={{ borderBottom: "1px solid var(--rtm-border)", background: "var(--rtm-bg)"}}>
                {["User", "Role", "Department", "Status", "Assigned Clients", "Last Active", "Actions"].map((h) => (
                  <th
                    key={h}
                    className="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-wider"style={{ color: "var(--rtm-text-muted)"}}
                  >
                    {h}
                  </th>
                ))}
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      <div
                        className="w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0"style={{ background: user.avatarColor }}
                      >
                        {user.initials}
                      </div>
                      <div>
                  ...
                  <td className="px-4 py-3">
                    <span
                      className="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-semibold"style={{
                  ...
                  <td className="px-4 py-3 text-center">
                    <span
                      className="inline-flex items-center justify-center w-8 h-7 rounded-lg text-sm font-bold"style={{
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <button
                        className="text-xs px-2.5 py-1 rounded-lg border font-medium transition-colors"style={{
                          borderColor: "var(--rtm-border)",
        ...
        <div
          className="px-4 py-3 flex items-center justify-between text-xs"style={{ borderTop: "1px solid var(--rtm-border)", color: "var(--rtm-text-muted)"}}
        >
