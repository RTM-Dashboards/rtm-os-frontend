      ...
      {activeTab === "engagement" && (
        <div className="space-y-5">
          ...
          <SectionWrapper
            ...
            description="Highest engagement and lead generation"
            actions={<span className="text-xs font-semibold" style={{ color: "#059669" }}>{topContent.length} items</span>}
          >
          ...
          {/* Low Performers */}
          <SectionWrapper
            title="⚠️ Low Performing Content"
            description="Needs optimization or review"
            actions={<span className="text-xs font-semibold text-amber-600">{lowContent.length} items</span>}
          >
          ...
          <SectionWrapper
            title="All Content"
            description="Full content inventory with performance data"
            actions={<span className="text-xs" style={{ color: "var(--rtm-text-muted)" }}>{contentItems.length} items</span>}
          >
      ...
      {activeTab === "upload" && (
        <div className="space-y-5">
          ...
          <SectionWrapper
            ...
            description="Full upload pipeline — SEO tasks to live content"
            actions={<span className="text-xs" style={{ color: "var(--rtm-text-muted)" }}>{uploadItems.length} items</span>}
          >
