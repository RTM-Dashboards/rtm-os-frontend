    ...
    <div className="flex flex-col min-h-screen" style={{ background: "var(--rtm-bg)" }}>
      ...
      <div className="flex-1 px-6 py-5 max-w-[1400px] mx-auto w-full">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-3 mb-6">
          <KpiCard label="Total Rules" value={kpis.total} icon="🤖" color="var(--rtm-blue)" />
          <KpiCard label="Active" value={kpis.active} icon="✅" color="#059669" />
          <KpiCard label="Paused" value={kpis.paused} icon="⏸️" color="#D97706" />
          <KpiCard label="Errors" value={kpis.errors} icon="🔴" color="#DC2626" />
          <KpiCard label="Total Runs" value={kpis.totalRuns} icon="▶️" color="var(--rtm-blue)" />
          <KpiCard label="Failed Runs" value={kpis.failedRuns} icon="❌" color="#DC2626" />
        </div>
