...
//  Types 
type ReviewStatus =
  | "Pending Assignment"| "Assigned"| "In Review"| "Approved"| "Revision Requested"| "Overdue";
            ...
            <div className="space-y-2">
              {deptSummary.map((d) => {
                ...
                return (
                  <div
                    key={d.dept}
                    className="flex items-center justify-between px-3 py-2 rounded-lg border cursor-pointer hover:opacity-80 transition-opacity"style={{ borderColor: "var(--rtm-border-light)", background: deptStyle.bg }}
