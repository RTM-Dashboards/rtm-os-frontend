...
export default function ReportingGBPPage() {
  return (
    <ReportingWorkspaceDeptPage
      title="GBP Reports — Reporting Workspace"
      description="Compiled Google Business Profile reports ready for QA and client delivery."
      accent="#059669"
      dept="GBP"
      reports={gbpReports}
      kpis={kpis}
      deptSourceHref="/seo-local/gbp/reports"
