...
export default function ReportingPaidAdsPage() {
  return (
    <ReportingWorkspaceDeptPage
      title="Paid Advertising Reports — Reporting Workspace"
      description="Compiled paid advertising reports ready for QA and client delivery."
      accent="#DC2626"
      dept="Paid Advertising"
      reports={paidReports}
      kpis={kpis}
      deptSourceHref="/paid-advertising/reports"
