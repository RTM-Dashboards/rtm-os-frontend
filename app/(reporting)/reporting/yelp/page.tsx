...
export default function ReportingYelpPage() {
  return (
    <ReportingWorkspaceDeptPage
      title="Yelp Reports — Reporting Workspace"
      description="Compiled Yelp department reports ready for QA and client delivery."
      accent="#D97706"
      dept="Yelp"
      reports={yelpReports}
      kpis={kpis}
      deptSourceHref="/seo-local/yelp/reports"
