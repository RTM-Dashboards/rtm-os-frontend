    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        <KpiCard
          ...
          value={String(kpiData.reportsDueThisWeek)}
          trend="down"
          trendValue="2"
          iconBg="#FFFBEB"
          iconColor="#D97706"
        ...
        <KpiCard
          ...
          value={String(kpiData.reportsOverdue)}
          trend="up"
          trendValue="1"
          iconBg="#FEF2F2"
          iconColor="#DC2626"
        ...
        />
        <KpiCard
          title="Waiting For Dept Input"
          value={String(kpiData.reportsWaitingForDeptInput)}
          trend="down"
          trendValue="1"
          iconBg="#FFF7ED"
          iconColor="#EA580C"
        ...
        <KpiCard
          title="Reports In QA"
          value={String(kpiData.reportsInQA)}
          trend="up"
          trendValue="1"
          iconBg="#F0FDF4"
          iconColor="#16A34A"
        ...
        />
        <KpiCard
          title="Waiting For AM Review"
          value={String(kpiData.reportsWaitingForAMReview)}
          trend="down"
          trendValue="2"
          iconBg="#F5F3FF"
          iconColor="#7C3AED"
        ...
        <KpiCard
          ...
          value={String(kpiData.reportsReadyToSend)}
          trend="up"
          trendValue="2"
          iconBg="#ECFDF5"
          iconColor="#059669"
        ...
        />
        <KpiCard
          title="Reports Sent This Month"
          value={String(kpiData.reportsSentThisMonth)}
          trend="up"
          trendValue="8"
          iconBg="#EFF6FF"
          iconColor="#2563EB"
      ...
      <SectionWrapper title="Action Center" description="Quick actions for the full report production and delivery workflow">
        <div className="flex flex-wrap gap-2">
          {[
            ...
            <button
              key={action.label}
              className="text-xs font-semibold px-3 py-2 rounded-lg border transition-all hover:opacity-90 hover:shadow-sm"
              style={{ color: action.color, background: action.bg, borderColor: `${action.color}40` }}
            >
              {action.label}
            </button>
          ))}
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                {[
                  ...
                  <button
                    ...
                    style={{ color: btn.color, background: btn.bg, borderColor: `${btn.color}40` }}
                  >
                    {btn.label}
                  </button>
                ))}
                ...
                <tbody>
                  {execClientHealthData.map((row, i) => (
                    <tr key={i} className="hover:bg-slate-50/50 transition-colors" style={{ borderBottom: "1px solid var(--rtm-border-light)" }}>
                      ...
                      <td className="py-2.5 px-3 whitespace-nowrap">
                        {row.upsell !== "None"
                          ? <span className="text-xs font-semibold px-2 py-0.5 rounded-full" style={{ background: "#EFF6FF", color: "#2563EB" }}>{row.upsell}</span>
