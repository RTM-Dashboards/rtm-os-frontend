      ...
      <div className="flex flex-wrap gap-3 items-center">
        <div className="relative flex-1 min-w-[200px] max-w-xs">
          ...
          <input
            ...
            style={{ borderColor: "var(--rtm-border-light)", background: "var(--rtm-bg-secondary)" }}
          />
        </div>
        ...
        <button
          className="ml-auto text-xs font-semibold px-4 py-2 rounded-lg border transition-all"
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2">
          <SectionWrapper
            ...
            description={`${filtered.length} connector${filtered.length !== 1 ? "s" : ""} — ${selectedCategory === "All" ? "all categories" : selectedCategory}`}
          >
              ...
              <SectionWrapper title="Connector Detail" description={selectedConnector.name}>
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    ...
                    <span
                      className="text-xs font-semibold px-2 py-0.5 rounded-full"
                      style={{ background: categoryColors[selectedConnector.category].bg, color: categoryColors[selectedConnector.category].color }}
                    >
                ...
                {(["Analytics", "Advertising", "CRM", "Call Tracking", "AI", "Custom API"] as ConnectorCategory[]).map((cat) => {
                  ...
                  return (
                    <div
                      ...
                      style={{ borderColor: "var(--rtm-border-light)", background: catStyle.bg }}
                      onClick={() => setSelectedCategory(cat)}
                    >
                      <div>
