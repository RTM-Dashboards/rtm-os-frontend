...
export default function ReportingLSAPage() {
  return (
    <ReportingWorkspaceDeptPage
      title="LSA Reports — Reporting Workspace"
      description="Compiled Local Service Ads reports ready for QA and client delivery."
      accent="#B45309"
      dept="LSA"
      reports={lsaReports}
      kpis={kpis}
      deptSourceHref="/local-service-ads/reports"
