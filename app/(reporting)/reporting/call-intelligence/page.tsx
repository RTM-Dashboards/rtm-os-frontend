...
type CallClassification =
  | "Qualified Lead"| "Booked Lead"| "Spam"| "Existing Client"| "Wrong Number"| "Competitor"| "Missed Opportunity"| "Unqualified"| "Follow-Up Required";

type ServiceType =
  | "SEO"| "GBP"| "PPC"| "Meta Ads"| "LSA"| "Website"| "Hosting"| "AI Automation"| "Custom Service";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        <KpiCard
          title="Total Calls"value={String(kpis.totalCalls)}
          subtitle="This period"iconBg="#EFF6FF"iconColor="#1D4ED8"icon={<svg className="w-5 h-5"fill="none"stroke="currentColor"viewBox="0 0 24 24"><path strokeLinecap="round"strokeLinejoin="round"strokeWidth={1.75} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>}
        />
        <KpiCard
          title="Qualified Leads"value={String(kpis.qualifiedLeads)}
          subtitle={`${kpis.bookedLeads} booked`}
          trend="up"trendValue="12%"iconBg="#ECFDF5"iconColor="#059669"icon={<svg className="w-5 h-5"fill="none"stroke="currentColor"viewBox="0 0 24 24"><path strokeLinecap="round"strokeLinejoin="round"strokeWidth={1.75} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>}
        />
        <KpiCard
          title="Booking Rate"value={`${kpis.bookingPct}%`}
          subtitle="Booked / Total calls"trend="up"trendValue="3%"iconBg="#F5F3FF"iconColor="#7C3AED"icon={<svg className="w-5 h-5"fill="none"stroke="currentColor"viewBox="0 0 24 24"><path strokeLinecap="round"strokeLinejoin="round"strokeWidth={1.75} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>}
        />
        <KpiCard
          title="Avg Lead Quality"value={`${kpis.avgQualityScore}/100`}
          subtitle="AI quality score"trend="up"trendValue="4pts"iconBg="#FFF7ED"iconColor="#D97706"icon={<svg className="w-5 h-5"fill="none"stroke="currentColor"viewBox="0 0 24 24"><path strokeLinecap="round"strokeLinejoin="round"strokeWidth={1.75} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg>}
        />
        <KpiCard
          title="Missed Opportunities"value={String(kpis.missedOpportunities)}
          subtitle="Recoverable"trend="down"trendValue="2"iconBg="#FEF2F2"iconColor="#DC2626"icon={<svg className="w-5 h-5"fill="none"stroke="currentColor"viewBox="0 0 24 24"><path strokeLinecap="round"strokeLinejoin="round"strokeWidth={1.75} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>}
        />
        <KpiCard
          title="Follow-Up Needed"value={String(kpis.followUpNeeded)}
          subtitle="Requires action"iconBg="#FFFBEB"iconColor="#D97706"icon={<svg className="w-5 h-5"fill="none"stroke="currentColor"viewBox="0 0 24 24"><path strokeLinecap="round"strokeLinejoin="round"strokeWidth={1.75} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>}
        />
        <KpiCard
          title="Spam / Wrong Number"value={String(kpis.spam)}
          subtitle={`${Math.round((kpis.spam / kpis.totalCalls) * 100)}% of total`}
          iconBg="#F8FAFC"iconColor="#64748B"icon={<svg className="w-5 h-5"fill="none"stroke="currentColor"viewBox="0 0 24 24"><path strokeLinecap="round"strokeLinejoin="round"strokeWidth={1.75} d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"/></svg>}
        />
        <KpiCard
          title="Upsell Signals"value={String(CALLS.filter((c) => c.upsellOpportunity !== "None").length)}
          subtitle="Identified by AI"iconBg="#F5F3FF"iconColor="#6D28D9"icon={<svg className="w-5 h-5"fill="none"stroke="currentColor"viewBox="0 0 24 24"><path strokeLinecap="round"strokeLinejoin="round"strokeWidth={1.75} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg>}
        />
      </div>
                          ...
                          >
                            ...
                            <td className="py-2.5 px-3 text-center">
                              {call.leadQualityScore > 0 ? (
                                <span
                                  className="text-xs font-bold"style={{ color: call.leadQualityScore >= 80 ? "#059669": call.leadQualityScore >= 60 ? "#D97706": "#DC2626"}}
                                >
