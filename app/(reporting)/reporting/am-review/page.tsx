...
//  Types 
type AMReviewStatus =
  | "Pending AM Review"| "In Review"| "Approved"| "Revision Requested"| "Escalated";

type DeliveryStatus =
  | "Not Ready"| "Ready to Deliver"| "Scheduled"| "Delivered"| "Feedback Received"| "Follow-Up Needed";
            ...
            <div className="space-y-2">
              {amSummary.map((am) => {
                ...
                return (
                  <div
                    key={am.am}
                    className="flex items-center justify-between px-3 py-2.5 rounded-lg border cursor-pointer hover:opacity-80 transition-opacity"style={{ borderColor: "var(--rtm-border-light)", background: amStyle.bg }}
