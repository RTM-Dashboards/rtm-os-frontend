            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Client Activation — Invoice Paid"
                  className="w-full px-3 py-2 rounded-lg text-sm border focus:outline-none focus:ring-2 focus:ring-blue-400"
              ...
              {ACTION_OPTIONS.map((a) => (
                ...
                >
                  <input
                    type="checkbox"
                    className="rounded"
                    checked={state.actions.includes(a.id)}
              ...
              {NOTIFICATION_OPTIONS.map((n) => (
                ...
                >
                  <input
                    type="checkbox"
                    className="rounded"
                    checked={state.notifications.includes(n.id)}
              ...
              {ESCALATION_OPTIONS.map((e) => (
                ...
                >
                  <input
                    type="checkbox"
                    className="rounded"
                    checked={state.escalations.includes(e.id)}
              ...
              {APPROVAL_OPTIONS.map((a) => (
                ...
                >
                  <input
                    type="checkbox"
                    className="rounded"
                    checked={state.approvals.includes(a.id)}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: "rgba(15,28,56,0.55)" }}>
      ...
      >
        ...
        <div
          ...
          style={{ borderBottom: "1px solid var(--rtm-border)", background: "var(--rtm-blue-xlight)" }}
        >
          <div>
        ...
        {/* Step Nav */}
        <div
          className="flex items-center gap-1 px-6 py-3 flex-shrink-0 overflow-x-auto"
          style={{ borderBottom: "1px solid var(--rtm-border-light)", background: "var(--rtm-bg)" }}
        >
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div
            className="absolute right-0 top-8 z-20 w-44 rounded-xl shadow-lg overflow-hidden"
            style={{ background: "var(--rtm-surface)", border: "1px solid var(--rtm-border)" }}
          >
            {[
              ...
              <button
                ...
                className="w-full flex items-center gap-2.5 px-3.5 py-2.5 text-xs font-medium transition-colors hover:bg-gray-50 text-left"
                style={{ color: (item as { danger?: boolean }).danger ? "#DC2626" : "var(--rtm-text-primary)" }}
              >
  ...
  return (
    ...
    >
      ...
      <div className="px-5 py-3 flex items-center gap-2">
        <button
          onClick={onUse}
          className="flex-1 px-3 py-2 rounded-lg text-xs font-bold text-white transition-opacity hover:opacity-90"
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mt-3">
        ...
        <button
          className="ml-auto text-[11px] font-semibold px-2.5 py-1 rounded-lg transition-colors hover:opacity-80"
          ...
          {NAV_LINKS.map((link, i) => (
            <React.Fragment key={link.href + link.label}>
              ...
              <a
                ...
                style={
                  link.label === "Workflow Engine"
                    ? { color: "var(--rtm-blue)", fontWeight: 700 }
                    : { color: "var(--rtm-text-secondary)" }
                }
              >
                {link.label}
          ...
          >
            ...
            >
              <input
                ...
                className="px-3 py-2 rounded-lg text-sm border focus:outline-none focus:ring-2 focus:ring-blue-400 min-w-[200px]"
              ...
              <select
                ...
                className="px-3 py-2 rounded-lg text-sm border focus:outline-none focus:ring-2 focus:ring-blue-400"
                style={{ borderColor: "var(--rtm-border)", background: "var(--rtm-surface)" }}
              >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1">
                          <button
                            ...
                            style={{ borderColor: "var(--rtm-border)", color: "var(--rtm-blue)" }}
                            title="Edit"
                          >
                            <IconSettings className="w-3.5 h-3.5" />
                          </button>
                ...
                <tbody>
                  {EXECUTION_HISTORY.map((rec, i) => (
                    <tr
                      key={rec.id}
                      className="hover:bg-blue-50/30 transition-colors"
                      style={{ borderBottom: i < EXECUTION_HISTORY.length - 1 ? "1px solid var(--rtm-border-light)" : "none" }}
                    >
                      <td className="px-4 py-3">
        ...
        {tab === "ai" && (
          <div className="space-y-4">
            <div
              ...
              style={{ background: "linear-gradient(135deg, #0E2055, #1B4FD8)", border: "1px solid #1B4FD8" }}
            >
