...
export default function LSAReportsPage() {
  return (
    <DeptReportPage
      title="LSA Reports"description="Local Service Ads report management — source data for Reporting Workspace."accent="#B45309"dept="LSA"reports={lsaDeptReports}
      kpis={kpis}
      reportingWorkspaceHref="/reporting/lsa"kpiSections={kpiSections}
    />
  );
}
