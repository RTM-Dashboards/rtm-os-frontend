    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        {[
          ...
          <button key={label} onClick={fn} className="px-4 py-2 rounded-lg text-sm font-semibold transition-all hover:opacity-90"
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 xl:grid-cols-8 gap-3">
        {[
          ...
          <div key={title}
            className="flex flex-col gap-2 p-4 rounded-xl border transition-shadow hover:shadow-md"
            style={{
      ...
      {activeTab !== "escalations" && (
        <div className="p-4 rounded-xl border space-y-3" style={{ background: "var(--rtm-surface)", borderColor: "var(--rtm-border)" }}>
          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            <input
              type="text"
              placeholder="Search client, title, user, dept…"
              value={search}
          ...
          {activeTab === "my" && (
            <div className="px-5 py-3 flex flex-wrap gap-2" style={{ borderBottom: "1px solid var(--rtm-border)", background: "var(--rtm-bg)" }}>
              {["Assigned To Me","My Department","Unread","Urgent","Overdue","Requires Action"].map((pill) => (
                <button key={pill} className="px-3 py-1 rounded-full text-xs font-semibold border transition-all"
