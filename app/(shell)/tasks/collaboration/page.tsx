...
const VIEW_LABELS: Record<ViewMode, { label: string; icon: string }> = {
  ...
  "dashboard":        { label: "Dashboard",         icon: "🏗️" },
          ...
          <div className="space-y-4">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    <Metric icon="💬" value={collab.comments.length} label="comments" />
                    <Metric icon="🔒" value={collab.internalNotes.length} label="int. notes" />
                    <Metric icon="🤝" value={collab.clientNotes.length} label="client notes" />
                    <Metric icon="📎" value={collab.attachments.length} label="files" />
                    <Metric icon="👁️" value={collab.watchers.filter((w) => w.watching).length} label="watchers" />
                    <Metric icon="✅" value={collab.approvals.length} label="approvals" />
                    <Metric icon="🔗" value={collab.dependencies.length} label="deps" />
                    <Metric icon="📋" value={collab.activity.length} label="events" />
                    <Metric icon="⚡" value={collab.escalations.length} label="escalations" />
                  </div>
            ...
            >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {[
                  { icon: "🗂️", tab: "Overview", desc: "Health, alerts, quick view" },
