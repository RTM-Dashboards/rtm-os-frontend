    ...
    <div className="fixed inset-0 z-50 flex justify-end" style={{ background: "rgba(15,28,56,0.35)" }} onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-start justify-between gap-4 px-6 py-5" style={{ background: "var(--rtm-surface)", borderBottom: "1px solid var(--rtm-border)" }}>
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 text-lg font-bold transition-colors hover:bg-red-50"
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div
            className="absolute right-0 top-full mt-1 z-20 w-48 rounded-xl border shadow-lg overflow-hidden"
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <KpiCard
          ...
          value={String(referralLeadsTotal)}
        ...
        <KpiCard
          ...
          value={String(qualifiedReferralsTotal)}
        ...
        <KpiCard
          ...
          value={`$${Math.round(referralRevenueTotal / 1000)}k/mo`}
        ...
        <KpiCard
          ...
          value={`$${Math.round(pendingCommissionsTotal).toLocaleString()}`}
        ...
        <KpiCard
          ...
          value={`$${Math.round(paidCommissionsTotal).toLocaleString()}`}
          trend="up" trendValue="22%"
          iconBg="#ECFDF5" iconColor="#059669"
        ...
        />
        <KpiCard
          title="Avg. Affiliate Value"
          value={`$${Math.round(avgAffiliateValue / 100) * 100}/mo`}
          iconBg="#EFF6FF" iconColor="#2563EB"
      ...
      {/* ── Workflow Attribution ─────────────────────────────────────────── */}
      <SectionWrapper
        title="Referral Workflow Attribution"
        description="End-to-end affiliate referral flow from submission to commission payout"
      >
      ...
      <SectionWrapper
        ...
        description="All affiliate partners with performance metrics, commission status, and portal access"
        actions={
          <div className="flex gap-2">
      ...
      >
        ...
        <div className="flex flex-wrap gap-3 mb-4">
          <input
            ...
            className="rtm-input text-sm w-56"
      ...
      <SectionWrapper
        ...
        description="All referrals across the pipeline with stage, rep assignment, and commission status"
        actions={
      ...
      <SectionWrapper
        ...
        description="All commission records across affiliates with approval status and payment dates"
        actions={
          <div className="flex gap-2">
      ...
      <SectionWrapper
        ...
        description="All affiliate referral links with click tracking, lead attribution, and performance metrics"
        actions={
          <div className="flex gap-2">
            <button className="text-xs font-semibold px-3 py-1.5 rounded-lg border" style={{ background: "#EFF6FF", color: "#2563EB", borderColor: "#BFDBFE" }} onClick={() => alert("[Mock] Generate New Link")}>Generate Link</button>
      ...
      <SectionWrapper
        ...
        description="Review pending commissions and record affiliate payouts"
        actions={
          <div className="flex gap-2">
      ...
      <SectionWrapper
        ...
        description="Create and manage affiliate-related tasks linked to /tasks"
        actions={
      ...
      <SectionWrapper
        ...
        description="Recent affiliate-related notifications and alerts linked to /notifications"
        actions={
