...
// No dedicated IT / Security service tag exists in activeServices; show all
// active clients. When an IT-specific service label is added to the data layer,
...
export default function ITSecurityClientsPage() {
  ...
  useEffect(() => {
    fetch("/api/master-clients")
      ...
      .then((data: { clients: DeptClientRecord[] }) => {
        // Show all clients; no IT & Security-specific service tag in master data yet
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: "var(--rtm-text-secondary)" }}>
          All clients receiving IT &amp; Security support.
        </p>
      </div>
