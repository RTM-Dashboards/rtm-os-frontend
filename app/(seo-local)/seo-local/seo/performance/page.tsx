  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-3 gap-4">
        {isEnabled("seo-organic-traffic") && <KpiCard
        ...
        />}
        {isEnabled("seo-organic-leads") && <KpiCard
        ...
        />}
        {isEnabled("seo-tech-score") && <KpiCard
        ...
        />}
        {isEnabled("seo-avg-visibility") && <KpiCard
      ...
      {/* Additional KPI row */}
      <div className="grid grid-cols-2 xl:grid-cols-3 gap-4">
        {isEnabled("seo-top-keyword-rank") && <KpiCard
