...
export default function SEOReportsPage() {
  return (
    <DeptReportPage
      title="SEO Reports"description="SEO department report management — source data for Reporting Workspace."accent="#2563EB"dept="SEO"reports={seoDeptReports}
      kpis={kpis}
      reportingWorkspaceHref="/reporting/seo"kpiSections={kpiSections}
    />
  );
}
