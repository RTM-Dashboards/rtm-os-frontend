...
// Service tags present in master-clients data for SEO & Local clients.
// This drives both the client-list filter and the per-card service tag row.
  ...
  return (
    <div className="space-y-6">
      ...
      <SectionWrapper
        ...
        description={
          loading ? "Loading…" : error ? error : `${clients.length} clients`
        }
      >
        {loading ? (
          <p
      ...
      <div className="flex gap-2 flex-wrap">
        ...
        <Link
          href="/seo-local/health"
          className="rtm-btn-secondary text-sm inline-flex items-center gap-1"
        >
          Client Health →
        </Link>
        <Link
          href="/seo-local/organic-performance"
          className="rtm-btn-secondary text-sm inline-flex items-center gap-1"
        >
          Organic Performance →
        </Link>
