...
export default function GBPReportsPage() {
  return (
    <DeptReportPage
      title="GBP Reports"
      description="Google Business Profile department report management — source data for Reporting Workspace."
      accent="#059669"
      dept="GBP"
      reports={gbpDeptReports}
      kpis={kpis}
      reportingWorkspaceHref="/reporting/gbp"
