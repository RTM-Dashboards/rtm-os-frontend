  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        <KpiCard title="Active Profiles" value="38" trend="up" trendValue="+4 new"
        ...
        />
        <KpiCard title="Avg. Review Score" value="4.6 ★" trend="up" trendValue="+0.1 pts"
        ...
        />
        <KpiCard title="Reviews (MTD)" value="67" trend="up" trendValue="+11"
          accentColor="bg-[var(--rtm-blue-xlight)]"
          icon={<svg className="w-5 h-5 text-[var(--rtm-blue)]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" /></svg>}
        />
        <KpiCard title="Needs Review" value="2" trend="down" trendValue="-1 resolved"
