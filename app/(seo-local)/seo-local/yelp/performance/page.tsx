...
const quickActions: QuickAction[] = [
  ...
  { label: "Category Audit",     description: "Check Yelp categories",    icon: "🗂️", color: "bg-purple-100 text-purple-600" },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        />
        <KpiCard
          title="Avg Listing Health Score"
        ...
        />
        <KpiCard
          title="Avg Review Visibility"
          value={`${totals.avgReviewVisibility}/100`}
      ...
      <SectionWrapper
        ...
        description={`${filteredListings.length} listing${filteredListings.length !== 1 ? "s" : ""} — ${DATE_RANGE_LABELS[filters.dateRange]}`}
        noPadding
        actions={
