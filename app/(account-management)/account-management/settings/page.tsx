    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border p-5" style={{ background: "var(--rtm-surface)", borderColor: "var(--rtm-border)" }}>
        ...
        <div className="flex items-center gap-4 p-4 rounded-lg" style={{ background: "var(--rtm-bg)", border: "1px solid var(--rtm-border-light)" }}>
          ...
          <span
            ...
            style={{ background: "#1B4FD818", color: "#1B4FD8" }}
          >
            Admin
          </span>
        </div>
      ...
      <div className="rounded-xl border overflow-hidden" style={{ background: "var(--rtm-surface)", borderColor: "var(--rtm-border)" }}>
        <div
          ...
          style={{ background: "var(--rtm-bg)", borderBottom: "1px solid var(--rtm-border)" }}
        >
          <div>
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span
                      ...
                      style={{ background: `${accessColors[m.access]}18`, color: accessColors[m.access] }}
                    >
                      {m.access}
                    </span>
                  </td>
            ...
            >
              ...
              >
                <span
                  ...
                  style={{ transform: perm.enabled ? "translateX(18px)" : "translateX(3px)" }}
                />
              </button>
            </div>
          ))}
          ...
          {notifications.map((notif, i) => (
            ...
            >
              ...
              >
                <span
                  className="inline-block w-3.5 h-3.5 rounded-full bg-white shadow transition-transform"
                  style={{ transform: notif.enabled ? "translateX(18px)" : "translateX(3px)" }}
                />
              </button>
            </div>
          ))}
