...
const reports = [
  { title: "May Account Summary — Apex Roofing",     client: "Apex Roofing",    date: "Jun 5",  status: "success" as const, label: "Delivered" },
  { title: "Q2 Review — Pacific Dental",             client: "Pacific Dental",  date: "Jun 8",  status: "pending" as const, label: "Pending"   },
  { title: "At-Risk Report — Sunbelt HVAC",          client: "Sunbelt HVAC",    date: "Jun 6",  status: "error"   as const, label: "Urgent"    },
  { title: "Quarterly Summary — Harbor Auto",        client: "Harbor Auto",     date: "Jun 10", status: "pending" as const, label: "Pending"   },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: "var(--rtm-text-secondary)" }}>Client account health and review reports.</p>
      </div>
      <SectionWrapper title="Reports" description={`${reports.length} reports`}>
